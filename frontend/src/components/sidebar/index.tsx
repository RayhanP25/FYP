        ...
        <aside className="w-64 bg-background-main border-r border-border h-screen flex flex-col fixed left-0 top-0">
            <div className="p-6 border-b border-border">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg font-semibold text-text">SPORTPOSE</span>
                </div>
            </div>
            ...
            <div className="p-4 border-t border-border">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-background border border-border rounded-lg text-sm text-text placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary"
                    />
                </div>
            </div>
                        ...
                        <DropdownMenuTrigger className="w-full">
                            <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-background transition-colors cursor-pointer">
                                ...
                                <div className="flex-1 text-left">
                                    <div className="text-sm font-medium text-text">{user?.full_name || 'User'}</div>
